...
<form class="row g-3 margin-top-12" method="post" action="{{ route('create') }}">
    @csrf
    ...
    <div class="card mb-10 search-box">
          ...
          <div class="form-row">
            ...
            <input type="text" name="user_name" placeholder="Jose.Campos" class="form-control" >
            </div>
            ...
            <div class="form-group col-md-2">
              ...
              <select name="supervisor_id"  class="form-select">
                @foreach($SUPER as $SR)
                <option value="{{$SR->id}}">{{$SR->user_name}}</option>
                @endforeach
            </select>
            </div>
      ...
      <div class="card-body">
        <div class="form-row">
          ...
          <div class="form-group col-md-2 mb-3">
            ...
            <input type="text" name="bairro" id="bairro" class="form-control" placeholder="exemplo@gmail.com">
          </div>

          <div class="form-group col-md-1 mb-3">
            <label class="form-label title-white">Numero</label>
            <input type="text" name="num_fachada" class="form-control">
          </div>
