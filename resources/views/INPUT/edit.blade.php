...
<div class="form-row"> 
  ...
  <form class="row g-3 margin-top-12" method="post" enctype="multipart/form-data" action="{{ URL('/input/update/'.$vend->id) }}" >
    ...
    <div class="card mb-10 search-box">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-2">
              <label  class="form-label">Numero RG</label>
            ...
            <div class="form-group col-md-2">
              <label  class="form-label">Segundo Telefone</label>
  ...
  <br>
    ...
    <div class="card mb-10 search-box">
        ...
        <div class="form-row"> 
          ...
          <label  class="form-label">Virtua</label>
          ...
          <div class="form-group col-md-5">
          <label  class="form-label">Grade de Canais</label>
  ...
  <br>
      ...
      <div class="form-group col-md-5">
          <label for="vencimento">Dia da Fatura</label>
  ...
  <br>
    ...
    <div class="card mb-10 search-box"  >
        ...
        <div class="form-group col-md-4">
              <label  class="form-label">Salvar Arquivos de img</label>
