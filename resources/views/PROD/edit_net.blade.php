...
<form class="row g-3 margin-top-12" method="post" action="{{ URL('/net/update/'.$product->id) }}">
    @csrf
    @method('PUT')
    ...
    <div class="card mb-12 search-box">
          ...
          <div class="form-row">
            ...
            <input type="text" name="net" value="{{$product->net}}" class="form-control" >
            </div>
            ...
            <form action="{{ URL('/net/destroy/'.$product->id) }}" method="POST">
            @csrf
            @method('DELETE')
